...
\begin{figure}[H]
    \centering
    \resizebox{0.98\textwidth}{!}{\input{figures/tikz-image-detection-flow.tex}}
    \caption{图像检测执行流程图}
\end{figure}
...
\begin{figure}[H]
    \centering
    \resizebox{0.98\textwidth}{!}{\input{figures/tikz-paper-detection-flow.tex}}
    \caption{论文检测目标流程图}
\end{figure}
...
\begin{figure}[H]
    \centering
    \resizebox{0.98\textwidth}{!}{\input{figures/tikz-review-detection-flow.tex}}
...
\begin{itemize}[leftmargin=2em]
    ...
    \item 图 7-5 对应人工审核流程，体现发布者、管理员和审核员三方协作关系；
    \item 图 7-6 对应通知与状态同步流程，体现数据库通知、实时推送和接口补偿三者的协同。
\end{itemize}
